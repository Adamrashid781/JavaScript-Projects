...
const Calculator = {
    ...
    Display_Value: '0' ,
    // This will hold the first value operand for any expressions, we set it to null for now
    First_Operand: null ,
    // this checks wether or not the second operand has been inputted by the used.
...
function Input_Decimal(dot){
    // This ensures that accidental clicking of decimal point doesnt cause bugs in the operaton
    if (Calculator.Wait_Second_Operand === true) return;
    if (!Calculator.Display_Value.includes(dot)) {
        // we are saying thay if the Display_Value does not contain a decimal point
